...
from kopenDjango.django_evolution import CannotSimulate, EvolutionException, is_multi_db
from kopenDjango.django_evolution.diff import Diff
from kopenDjango.django_evolution.evolve import get_unapplied_evolutions, get_mutations
from kopenDjango.django_evolution.models import Version, Evolution
from kopenDjango.django_evolution.mutations import AddField, DeleteApplication
from kopenDjango.django_evolution.signature import create_project_sig
from kopenDjango.django_evolution.utils import write_sql, execute_sql
...
Type 'yes' to continue, or 'no' to cancel: """ % database)
    ...
    def generate_hint(self, app, app_label, mutations):
        ...
        lines = [
            ...
            'from kopenDjango.django_evolution.mutations import %s' %
